...
<form name="regform" action="DoctorLoginController" method="post" onsubmit="return regValidate()">
      ...
      <label for="specialty"><b>Doctor Specialty</b></label>
	  <br><br>
	  	<input type="checkbox" name="specialty" value="none"> None
		<input type="checkbox" name="specialty" value="cancer"> Cancer
		<input type="checkbox" name="specialty" value="fever"> Fever/Cold
		<input type="checkbox" name="specialty" value="diabetes"> Diabetes
		<input type="checkbox" name="specialty" value="bleeding"> Bleeding Problems <br><br>
		<input type="checkbox" name="specialty" value="asthma"> Asthma 
		<input type="checkbox" name="specialty" value="diabetes"> Diabetes
		<input type="checkbox" name="specialty" value="heart"> Heart 
		<input type="checkbox" name="specialty" value="highBlood"> High Blood Pressure
		<input type="checkbox" name="specialty" value="Stroke"> Stroke
      <br><br>
      
      <label for="info"><b>Information</b></label>
