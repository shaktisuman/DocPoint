...
<div class="container">
  <form name="loginform" action="DoctorLoginController" method="post" onsubmit="return loginValidate()" >
...
<div class="container signin">
	<p>Not a doctor? <a href="login.jsp">Patient Sign in</a>  <a href="adminlogin.jsp">Admin Sign in</a>.</p>
</div>
